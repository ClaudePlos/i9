...
(function (awk) {
    ...
    (function (grid) {
        ...
        var ColumnController = (function () {
            ...
            // Custom method by junaid for percentage column fit ..
            
            ColumnController.prototype.sizeColumnsToPercentageFit = function (gridWidth) {
                ...
                var colsToNotSpread = _.filter(this.displayedColumns, function (column) {
                    return column.colDef.width > 0  ;
                });
                var colsToSpread = _.filter(this.displayedColumns, function (column) {
                    return column.colDef.percentWidth != undefined;
                });
                    ...
                    if (availablePixels <= 0) {
                      ...
                      //  var pixelsForLastCol = availablePixels;
                        ...
                        for (var i = colsToSpread.length - 1; i >= 0; i--) {
                            ...
                            var newWidth =  (column.colDef.percentWidth / 100) *  availablePixels ;
                            if (newWidth < column.getMinimumWidth()) {
                                column.setMinimum();
...
(function (awk) {
    ...
    (function (grid_2) {
        var GridApi = (function () {
            ...
            GridApi.prototype.sizeColumnsToPercentageFit = function () {
                if (this.gridOptionsWrapper.isDontUseScrolls()) {
                    console.warn('ag-grid: sizeColumnsToFit does not work when dontUseScrolls=true');
                    return;
                }
                var availableWidth = this.gridPanel.getWidthForSizeColsToFit();
                this.columnController.sizeColumnsToPercentageFit(availableWidth);
            };
